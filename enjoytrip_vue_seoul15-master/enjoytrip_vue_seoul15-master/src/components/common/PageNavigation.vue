...
<template>
  <ul class="pagenation-wrap">
    <li class="page-item">
      <a class="page-link btn btn-main" @click="onPageChange(1)">최신</a>
    </li>
    <li class="page-item">
      <a
        class="page-link btn btn-main"
    ...
    <template v-for="pg in range(startPage, endPage)" :key="pg">
      <li :class="currentPage === pg ? 'page-item active' : 'page-item'">
        <a class="page-link btn btn-main" @click="onPageChange(pg)">{{ pg }}</a>
      </li>
    </template>
    <li class="page-item">
      <a
    ...
    <li class="page-item">
      <a class="page-link btn btn-main" @click="onPageChange(totalPage)"
        >마지막</a
      >
    </li>
  </ul>
